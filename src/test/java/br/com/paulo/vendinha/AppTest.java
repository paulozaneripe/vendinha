...
public class AppTest {
	...
	public void compraDinheiroInsuficienteTest() {
		...
		assertEquals(c1.getNome() + " não possui esse dinheiro!", exception.getMessage());
	}
	...
	@Test
	public void reativarPedidoNaoCanceladoTest() {
		Produto p1 = new Produto("Refrigerante", BigDecimal.valueOf(6.3), 50);
		...
		assertEquals("Pedido não está cancelado!", exception.getMessage());
	}

	@Test
	public void reativarAposSegundaVezTest() {
		Produto p1 = new Produto("Refrigerante", BigDecimal.valueOf(6.3), 50);
		...
		assertEquals("Pedido está expirado e não pode ser mais reativado!", exception.getMessage());
	}

	@Test
	public void estornarUltimaCompraSemComprarTest() {
		Cliente c1 = new Cliente("Lucas", 1200);
		...
		assertEquals("Nenhuma compra efetuda por " + c1.getNome(), exception.getMessage());
	}
}
